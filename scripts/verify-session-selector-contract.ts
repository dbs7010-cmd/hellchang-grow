...
const selector = fs.readFileSync('src/components/session/session-exercise-selector.tsx', 'utf8');
const navigation = fs.readFileSync('src/utils/session-navigation.ts', 'utf8');
