...
export function buildDanbaekWorldScene(
  profile: DanbaekLearningProfile
): DanbaekWorldSceneState {
  ...
  return {
    ...
    recommendedMovementFamily: presentation.recommendedMovementFamily,
    specificExerciseId: presentation.specificExerciseId,
  };
}
