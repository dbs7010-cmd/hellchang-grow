...
/**
 * WORLD owns the meaning of a BLOCK, but not Stanley's workout prescription.
 * This view-model gives APP an actionable semantic payload without importing
 * APP navigation, trainer services, or workout repositories.
 */
