...
export const Exercises: ExerciseDefinition[] = [
  // 가슴
  {
    ...
    muscleSpDistribution: { chest: 0.6, triceps: 0.25, frontDelts: 0.15 },
    aliases: ['바벨 벤치프레스'],
  ...
  },
  {
    ...
    name: '인클라인 벤치프레스',
    animationFamily: 'horizontal_press',
    muscleSpDistribution: { chest: 0.5, frontDelts: 0.3, triceps: 0.2 },
    primaryMuscleGroup: 'chest',
  ...
  },
  {
    ...
    muscleSpDistribution: { chest: 0.4, triceps: 0.45, frontDelts: 0.15 },
    primaryMuscleGroup: 'chest',
    secondaryMuscleGroups: ['arms'],
  ...
  // 등
  {
    ...
    muscleSpDistribution: { lats: 0.55, biceps: 0.2, upperBack: 0.2, rearDelts: 0.05 },
  ...
  },
  {
    ...
    name: '풀업',
    animationFamily: 'vertical_pull',
    muscleSpDistribution: { lats: 0.55, biceps: 0.25, upperBack: 0.2 },
    primaryMuscleGroup: 'back',
    secondaryMuscleGroups: ['arms'],
    equipment: 'bodyweight',
    trackingType: 'reps_only',
  ...
  },
  {
    ...
    name: '스트레이트암 풀다운',
    animationFamily: 'vertical_pull',
    muscleSpDistribution: { lats: 0.8, upperBack: 0.2 },
    primaryMuscleGroup: 'back',
    equipment: 'cable',
    trackingType: 'weight_reps',
  },
  ...
  // 하체
  {
    ...
    muscleSpDistribution: { quads: 0.45, glutes: 0.3, hamstrings: 0.15, abs: 0.1 },
  ...
  },
  {
    ...
    muscleSpDistribution: { quads: 0.6, glutes: 0.25, hamstrings: 0.15 },
    primaryMuscleGroup: 'legs',
    equipment: 'machine',
    trackingType: 'weight_reps',
  },
  ...
  },
  {
    ...
    name: '레그컬',
    animationFamily: 'leg_isolation',
    muscleSpDistribution: { hamstrings: 1 },
    primaryMuscleGroup: 'legs',
    equipment: 'machine',
    trackingType: 'weight_reps',
  },
  {
    ...
    muscleSpDistribution: { hamstrings: 0.5, glutes: 0.35, upperBack: 0.15 },
    primaryMuscleGroup: 'legs',
  ...
  },
  {
    ...
    name: '런지',
    animationFamily: 'squat',
    muscleSpDistribution: { quads: 0.45, glutes: 0.4, hamstrings: 0.15 },
    primaryMuscleGroup: 'legs',
    equipment: 'dumbbell',
    trackingType: 'weight_reps',
  },
  {
    ...
    name: '힙쓰러스트',
    animationFamily: 'hip_hinge',
    muscleSpDistribution: { glutes: 0.7, hamstrings: 0.3 },
    primaryMuscleGroup: 'legs',
    equipment: 'barbell',
    trackingType: 'weight_reps',
  },
  ...
  // 어깨
  {
    ...
    name: '오버헤드프레스',
    animationFamily: 'vertical_press',
    muscleSpDistribution: { frontDelts: 0.5, sideDelts: 0.2, triceps: 0.25, abs: 0.05 },
  ...
  },
  {
    ...
    muscleSpDistribution: { sideDelts: 1 },
    primaryMuscleGroup: 'shoulders',
    equipment: 'dumbbell',
    trackingType: 'weight_reps',
  ...
  },
  {
    ...
    name: '리어델트 플라이',
    animationFamily: 'fly',
    muscleSpDistribution: { rearDelts: 0.8, upperBack: 0.2 },
    primaryMuscleGroup: 'shoulders',
    equipment: 'dumbbell',
    trackingType: 'weight_reps',
  },
  {
    ...
    name: '페이스풀',
    animationFamily: 'horizontal_pull',
    muscleSpDistribution: { rearDelts: 0.6, upperBack: 0.4 },
    primaryMuscleGroup: 'shoulders',
    secondaryMuscleGroups: ['back'],
    equipment: 'cable',
    trackingType: 'weight_reps',
  ...
  // 전신/코어
  {
    ...
    name: '데드리프트',
    animationFamily: 'hip_hinge',
    muscleSpDistribution: { hamstrings: 0.3, glutes: 0.3, upperBack: 0.25, quads: 0.15 },
  ...
  },
  {
    ...
    muscleSpDistribution: { quads: 0.3, chest: 0.2, abs: 0.2, glutes: 0.2, triceps: 0.1 },
    primaryMuscleGroup: 'fullBody',
    equipment: 'bodyweight',
    trackingType: 'reps_only',
  },
  ...
  },
  {
    ...
    name: '행잉레그레이즈',
    animationFamily: 'core',
    muscleSpDistribution: { abs: 0.85, lats: 0.15 },
    primaryMuscleGroup: 'core',
    equipment: 'bodyweight',
    trackingType: 'reps_only',
  },
