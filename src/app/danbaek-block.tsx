...
export default function DanbaekBlockScreen() {
  ...
  return <SubScreen title="단백이가 막힌 곳" accent>
    <DanbaekVoiceBubble line={presentation.danbaekLine} status={presentation.familyLabel} />
    <Section title="왜 멈췄어요?">
      <ThemedView type="backgroundElement" style={[styles.factCard, { borderColor: theme.border }]}>
        <ThemedText type="smallBold">{presentation.whyBlockedLine}</ThemedText>
        <ThemedText type="small" themeColor="textSecondary">{presentation.whatToLearnLine}</ThemedText>
      </ThemedView>
    </Section>
