...
export default function RootLayout() {
  return <ThemeProvider value={DarkTheme}><AppDataProvider><AnimatedSplashOverlay /><RootNavigator /></AppDataProvider></ThemeProvider>;
}
...
function RootNavigator() {
  ...
  return <Stack screenOptions={{ headerShown: false }}>
    <Stack.Protected guard={!onboardingComplete}><Stack.Screen name="(onboarding)" /></Stack.Protected>
...
const styles = StyleSheet.create({ recovery: { flex: 1, justifyContent: 'center', padding: Spacing.three, gap: Spacing.two } });
