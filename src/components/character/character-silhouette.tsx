 ...
 * BodyParameters may change muscle volume/definition only.  Head, face, tuft,
 * blush and D shorts are fixed identity from the approved 2026-08-26 visual CANON.
 */
function CharacterSilhouetteComponent({ bodyParameters, rotationYDeg = 0, idle = true, scale = 1 }: CharacterSilhouetteProps) {
        ...
        <View style={{ transform: [{ perspective: 900 }, { rotateY: `${rotationYDeg}deg` }, { scale }] }}>
          <Svg width={200} height={280} viewBox="0 0 200 280" accessibilityLabel="단백이 캐릭터">
            ...
            <G transform={`${bodyProportionTransform} ${bodyTransform}`} fill={stroke.fill} stroke={stroke.color} strokeWidth={stroke.width} strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* The shorts are costume, not body geometry: growth never distorts their identity. */}
            ...
            <G fill={fixedIdentity.blush.color} opacity={fixedIdentity.blush.opacity} stroke="none">
            ...
            <G fill={stroke.color}><Circle cx={fixedIdentity.eyes.leftX} cy={fixedIdentity.eyes.y} r={fixedIdentity.eyes.radius} /><Circle cx={fixedIdentity.eyes.rightX} cy={fixedIdentity.eyes.y} r={fixedIdentity.eyes.radius} /></G>
            <Path d={fixedIdentity.mouth} fill="#F46B62" stroke={stroke.color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" />
          </Svg>
        </View>
      </Animated.View>
    </View>
